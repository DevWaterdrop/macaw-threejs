...
export class MacawImage {
	...
	element!: HTMLImageElement; // TODO TEMPFIX !
	mesh!: THREE.Mesh; // TODO TEMPFIX !
	top!: number; // TODO TEMPFIX !
	left!: number; // TODO TEMPFIX !
	width!: number; // TODO TEMPFIX !
	height!: number; // TODO TEMPFIX !
	material!: THREE.ShaderMaterial; // TODO TEMPFIX !
	texture!: THREE.Texture; // TODO TEMPFIX !
